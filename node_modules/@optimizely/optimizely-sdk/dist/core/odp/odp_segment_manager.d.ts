...
export interface IOdpSegmentManager {
    fetchQualifiedSegments(userKey: ODP_USER_KEY, userValue: string, options: Array<OptimizelySegmentOption>): Promise<string[] | null>;
    reset(): void;
 ...
 */
export declare class OdpSegmentManager implements IOdpSegmentManager {
    /**
     ...
     * @private
     */
    private odpSegmentApiManager;
    /**
     * Handler for recording execution logs
     * @private
     */
    private readonly logger;
    constructor(segmentsCache: ICache<string, string[]>, odpSegmentApiManager: IOdpSegmentApiManager, logger?: LogHandler, odpConfig?: OdpConfig);
    /**
