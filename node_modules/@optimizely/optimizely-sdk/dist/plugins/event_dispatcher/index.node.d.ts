 ...
 */
export declare const dispatchEvent: (eventObj: Event, callback: (response: {
    statusCode: number;
}) => void) => http.ClientRequest | void;
declare const _default: {
    dispatchEvent: (eventObj: Event, callback: (response: {
        statusCode: number;
    }) => void) => void | http.ClientRequest;
};
