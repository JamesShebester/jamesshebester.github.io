...
var OptimizelyUserContext = /** @class */ (function () {
    function OptimizelyUserContext(_a) {
        ...
        if (shouldIdentifyUser) {
            ...
            // @ts-ignore
            optimizely.readyPromise.then(function (_a) {
    ...
    if (projectConfig.integrations) {
        ...
        projectConfig.integrations.forEach(function (integration) {
            if (!('key' in integration)) {
                throw new Error(sprintf(ERROR_MESSAGES.MISSING_INTEGRATION_KEY, MODULE_NAME$1));
            }
...
var AudienceEvaluator = /** @class */ (function () {
    ...
    AudienceEvaluator.prototype.evaluate = function (audienceConditions, audiencesById, user) {
        ...
        var evaluateAudience = function (audienceId) {
            ...
            if (audience) {
                logger$4.log(LOG_LEVEL.DEBUG, LOG_MESSAGES.EVALUATING_AUDIENCE, MODULE_NAME$7, audienceId, JSON.stringify(audience.conditions));
                ...
                logger$4.log(LOG_LEVEL.DEBUG, LOG_MESSAGES.AUDIENCE_EVALUATION_RESULT, MODULE_NAME$7, audienceId, resultText);
                return result;
            }
            return null;
        };
    ...
    AudienceEvaluator.prototype.evaluateConditionWithUserAttributes = function (user, condition) {
        ...
        if (!evaluator) {
            logger$4.log(LOG_LEVEL.WARNING, LOG_MESSAGES.UNKNOWN_CONDITION_TYPE, MODULE_NAME$7, JSON.stringify(condition));
            return null;
        }
        try {
            ...
            logger$4.log(LOG_LEVEL.ERROR, ERROR_MESSAGES.CONDITION_EVALUATOR_ERROR, MODULE_NAME$7, condition.type, err.message);
        }
        return null;
    };
 ...
 * limitations under the License.
 */
var logger$5 = getLogger('EVENT_BUILDER');
/**
...
var MODULE_NAME$b = 'NOTIFICATION_CENTER';
/**
        ...
        try {
            (this.notificationListeners[notificationType] || []).forEach(function (listenerEntry) {
                ...
                try {
                    ...
                    _this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.NOTIFICATION_LISTENER_EXCEPTION, MODULE_NAME$b, notificationType, ex.message);
                }
            });
        }
        catch (e) {
 ...
 * limitations under the License.
 */
var MODULE_NAME$c = 'EVENT_TAGS_VALIDATOR';
/**
...
function validate$3(eventTags) {
    if (typeof eventTags === 'object' && !Array.isArray(eventTags) && eventTags !== null) {
        ...
        throw new Error(sprintf(ERROR_MESSAGES.INVALID_EVENT_TAGS, MODULE_NAME$c));
    }
}
 ...
 * limitations under the License.                                           *
 ***************************************************************************/
var MODULE_NAME$d = 'USER_PROFILE_SERVICE_VALIDATOR';
/**
...
function validate$4(userProfileServiceInstance) {
    if (typeof userProfileServiceInstance === 'object' && userProfileServiceInstance !== null) {
        if (typeof userProfileServiceInstance['lookup'] !== 'function') {
            throw new Error(sprintf(ERROR_MESSAGES.INVALID_USER_PROFILE_SERVICE, MODULE_NAME$d, "Missing function 'lookup'"));
        }
        else if (typeof userProfileServiceInstance['save'] !== 'function') {
            throw new Error(sprintf(ERROR_MESSAGES.INVALID_USER_PROFILE_SERVICE, MODULE_NAME$d, "Missing function 'save'"));
        }
        return true;
    }
    throw new Error(sprintf(ERROR_MESSAGES.INVALID_USER_PROFILE_SERVICE, MODULE_NAME$d));
}
...
var Optimizely = /** @class */ (function () {
    function Optimizely(config) {
        ...
        if (!clientEngine) {
            config.logger.log(LOG_LEVEL.INFO, LOG_MESSAGES.INVALID_CLIENT_ENGINE, MODULE_NAME$e, clientEngine);
        ...
        if (!Array.isArray(decideOptionsArray)) {
            this.logger.log(LOG_LEVEL.DEBUG, LOG_MESSAGES.INVALID_DEFAULT_DECIDE_OPTIONS, MODULE_NAME$e);
            decideOptionsArray = [];
        }
        ...
        decideOptionsArray.forEach(function (option) {
            ...
            if (OptimizelyDecideOption[option]) {
                ...
                _this.logger.log(LOG_LEVEL.WARNING, LOG_MESSAGES.UNRECOGNIZED_DECIDE_OPTION, MODULE_NAME$e, option);
            }
        });
        ...
        this.disposeOnUpdate = this.projectConfigManager.onUpdate(function (configObj) {
            _this.logger.log(LOG_LEVEL.INFO, LOG_MESSAGES.UPDATED_OPTIMIZELY_CONFIG, MODULE_NAME$e, configObj.revision, configObj.projectId);
        ...
        if (config.userProfileService) {
            try {
                if (validate$4(config.userProfileService)) {
                    ...
                    this.logger.log(LOG_LEVEL.INFO, LOG_MESSAGES.VALID_USER_PROFILE_SERVICE, MODULE_NAME$e);
                }
            }
            catch (ex) {
    ...
    Optimizely.prototype.activate = function (experimentKey, userId, attributes) {
        try {
            if (!this.isValidInstance()) {
                this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'activate');
                return null;
            }
            ...
            try {
                ...
                if (!isRunning(configObj, experimentKey)) {
                    this.logger.log(LOG_LEVEL.DEBUG, LOG_MESSAGES.SHOULD_NOT_DISPATCH_ACTIVATE, MODULE_NAME$e, experimentKey);
                    return variationKey;
                }
                var experiment = getExperimentFromKey(configObj, experimentKey);
                ...
                this.logger.log(LOG_LEVEL.ERROR, ex.message);
                this.logger.log(LOG_LEVEL.INFO, LOG_MESSAGES.NOT_ACTIVATING_USER, MODULE_NAME$e, userId, experimentKey);
    ...
    Optimizely.prototype.track = function (eventKey, userId, attributes, eventTags) {
        try {
            if (!this.isValidInstance()) {
                this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'track');
                return;
            }
            ...
            if (!eventWithKeyExists(configObj, eventKey)) {
                this.logger.log(LOG_LEVEL.WARNING, LOG_MESSAGES.EVENT_KEY_NOT_FOUND, MODULE_NAME$e, eventKey);
                this.logger.log(LOG_LEVEL.WARNING, LOG_MESSAGES.NOT_TRACKING_USER, MODULE_NAME$e, userId);
                return;
            }
            ...
            this.logger.log(LOG_LEVEL.INFO, LOG_MESSAGES.TRACK_EVENT, MODULE_NAME$e, eventKey, userId);
            // TODO is it okay to not pass a projectConfig as second argument
            ...
            this.logger.log(LOG_LEVEL.ERROR, e.message);
            this.errorHandler.handleError(e);
            this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.NOT_TRACKING_USER, MODULE_NAME$e, userId);
        }
    };
    /**
    ...
    Optimizely.prototype.getVariation = function (experimentKey, userId, attributes) {
        try {
            if (!this.isValidInstance()) {
                this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'getVariation');
                return null;
            }
            try {
                if (!this.validateInputs({ experiment_key: experimentKey, user_id: userId }, attributes)) {
                ...
                if (!experiment || experiment.isRollout) {
                    this.logger.log(LOG_LEVEL.DEBUG, ERROR_MESSAGES.INVALID_EXPERIMENT_KEY, MODULE_NAME$e, experimentKey);
                    return null;
                }
        ...
        try {
            if (stringInputs.hasOwnProperty('user_id')) {
                ...
                if (typeof userId !== 'string' || userId === null || userId === 'undefined') {
                    throw new Error(sprintf(ERROR_MESSAGES.INVALID_INPUT_FORMAT, MODULE_NAME$e, 'user_id'));
                }
                delete stringInputs['user_id'];
            }
            Object.keys(stringInputs).forEach(function (key) {
                if (!validate$1(stringInputs[key])) {
                    throw new Error(sprintf(ERROR_MESSAGES.INVALID_INPUT_FORMAT, MODULE_NAME$e, key));
                }
            });
            if (userAttributes) {
    ...
    Optimizely.prototype.isFeatureEnabled = function (featureKey, userId, attributes) {
        try {
            if (!this.isValidInstance()) {
                this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'isFeatureEnabled');
                return false;
            }
            ...
            if (featureEnabled === true) {
                this.logger.log(LOG_LEVEL.INFO, LOG_MESSAGES.FEATURE_ENABLED_FOR_USER, MODULE_NAME$e, featureKey, userId);
            }
            else {
                this.logger.log(LOG_LEVEL.INFO, LOG_MESSAGES.FEATURE_NOT_ENABLED_FOR_USER, MODULE_NAME$e, featureKey, userId);
    ...
    Optimizely.prototype.getEnabledFeatures = function (userId, attributes) {
        ...
        try {
            ...
            if (!this.isValidInstance()) {
                this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'getEnabledFeatures');
    ...
    Optimizely.prototype.getFeatureVariable = function (featureKey, variableKey, userId, attributes) {
        try {
            if (!this.isValidInstance()) {
                this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'getFeatureVariable');
                return null;
            }
    ...
    Optimizely.prototype.getFeatureVariableForType = function (featureKey, variableKey, variableType, userId, attributes) {
        ...
        if (variableType && variable.type !== variableType) {
            this.logger.log(LOG_LEVEL.WARNING, LOG_MESSAGES.VARIABLE_REQUESTED_WITH_WRONG_TYPE, MODULE_NAME$e, variableType, variable.type);
            return null;
        }
        var user = this.createInternalUserContext(userId, attributes);
    ...
    Optimizely.prototype.getFeatureVariableValueFromVariation = function (featureKey, featureEnabled, variation, variable, userId) {
        ...
        if (variation !== null) {
            ...
            if (value !== null) {
                if (featureEnabled) {
                    variableValue = value;
                    this.logger.log(LOG_LEVEL.INFO, LOG_MESSAGES.USER_RECEIVED_VARIABLE_VALUE, MODULE_NAME$e, variableValue, variable.key, featureKey);
                }
                else {
                    this.logger.log(LOG_LEVEL.INFO, LOG_MESSAGES.FEATURE_NOT_ENABLED_RETURN_DEFAULT_VARIABLE_VALUE, MODULE_NAME$e, featureKey, userId, variableValue);
                }
            }
            else {
                this.logger.log(LOG_LEVEL.INFO, LOG_MESSAGES.VARIABLE_NOT_USED_RETURN_DEFAULT_VARIABLE_VALUE, MODULE_NAME$e, variable.key, variation.key);
            }
        }
        else {
            this.logger.log(LOG_LEVEL.INFO, LOG_MESSAGES.USER_RECEIVED_DEFAULT_VARIABLE_VALUE, MODULE_NAME$e, userId, variable.key, featureKey);
        }
    ...
    Optimizely.prototype.getFeatureVariableBoolean = function (featureKey, variableKey, userId, attributes) {
        try {
            if (!this.isValidInstance()) {
                this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'getFeatureVariableBoolean');
                return null;
            }
    ...
    Optimizely.prototype.getFeatureVariableDouble = function (featureKey, variableKey, userId, attributes) {
        try {
            if (!this.isValidInstance()) {
                this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'getFeatureVariableDouble');
                return null;
            }
    ...
    Optimizely.prototype.getFeatureVariableInteger = function (featureKey, variableKey, userId, attributes) {
        try {
            if (!this.isValidInstance()) {
                this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'getFeatureVariableInteger');
                return null;
            }
    ...
    Optimizely.prototype.getFeatureVariableString = function (featureKey, variableKey, userId, attributes) {
        try {
            if (!this.isValidInstance()) {
                this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'getFeatureVariableString');
                return null;
            }
    ...
    Optimizely.prototype.getFeatureVariableJSON = function (featureKey, variableKey, userId, attributes) {
        try {
            if (!this.isValidInstance()) {
                this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'getFeatureVariableJSON');
                return null;
            }
    ...
    Optimizely.prototype.getAllFeatureVariables = function (featureKey, userId, attributes) {
        ...
        try {
            if (!this.isValidInstance()) {
                this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'getAllFeatureVariables');
                return null;
            }
            if (!this.validateInputs({ feature_key: featureKey, user_id: userId }, attributes)) {
                return null;
    ...
    Optimizely.prototype.decide = function (user, key, options) {
        ...
        if (!this.isValidInstance() || !configObj) {
            this.logger.log(LOG_LEVEL.INFO, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'decide');
            return newErrorDecision(key, user, [DECISION_MESSAGES.SDK_NOT_READY]);
        }
        var feature = configObj.featureKeyMap[key];
        if (!feature) {
            this.logger.log(LOG_LEVEL.ERROR, ERROR_MESSAGES.FEATURE_NOT_IN_DATAFILE, MODULE_NAME$e, key);
        ...
        if (flagEnabled === true) {
            this.logger.log(LOG_LEVEL.INFO, LOG_MESSAGES.FEATURE_ENABLED_FOR_USER, MODULE_NAME$e, key, userId);
        }
        else {
            this.logger.log(LOG_LEVEL.INFO, LOG_MESSAGES.FEATURE_NOT_ENABLED_FOR_USER, MODULE_NAME$e, key, userId);
        }
        var variablesMap = {};
        ...
        if (!allDecideOptions[OptimizelyDecideOption.DISABLE_DECISION_EVENT] &&
            (decisionSource === DECISION_SOURCES.FEATURE_TEST ||
                (decisionSource === DECISION_SOURCES.ROLLOUT && getSendFlagDecisionsValue(configObj)))) {
    ...
    Optimizely.prototype.getAllDecideOptions = function (options) {
        ...
        if (!Array.isArray(options)) {
            this.logger.log(LOG_LEVEL.DEBUG, LOG_MESSAGES.INVALID_DECIDE_OPTIONS, MODULE_NAME$e);
        }
        else {
    ...
    Optimizely.prototype.decideForKeys = function (user, keys, options) {
        ...
        var decisionMap = {};
        if (!this.isValidInstance()) {
            this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'decideForKeys');
            return decisionMap;
        }
        if (keys.length === 0) {
            return decisionMap;
    ...
    Optimizely.prototype.decideAll = function (user, options) {
        ...
        var decisionMap = {};
        if (!this.isValidInstance() || !configObj) {
            this.logger.log(LOG_LEVEL.ERROR, LOG_MESSAGES.INVALID_OBJECT, MODULE_NAME$e, 'decideAll');
            return decisionMap;
        }
    ...
    Optimizely.prototype.getVuid = function () {
        ...
        if (!this.odpManager.isVuidEnabled()) {
            this.logger.log(LOG_LEVEL.WARNING, 'getVuid() unavailable for this platform', MODULE_NAME$e);
            return undefined;
        }
...
var createInstance = function (config) {
    try {
        ...
        var optimizelyOptions = __assign(__assign({ clientEngine: JAVASCRIPT_CLIENT_ENGINE }, config), { logger: logger$6, errorHandler: errorHandler, datafileManager: createNoOpDatafileManager(), eventProcessor: eventProcessor, notificationCenter: notificationCenter, isValidInstance: isValidInstance });
...
var index_lite = __assign(__assign({}, commonExports), { logging: loggerPlugin, errorHandler: defaultErrorHandler, eventDispatcher: noOpEventDispatcher, enums: enums, setLogger: setLogHandler, setLogLevel: setLogLevel, createInstance: createInstance, OptimizelyDecideOption: OptimizelyDecideOption });

export default index_lite;
export { LOG_LEVEL, LogLevel, OptimizelyDecideOption, OptimizelySegmentOption, createInstance, createLogger, enums, defaultErrorHandler as errorHandler, noOpEventDispatcher as eventDispatcher, getLogger, loggerPlugin as logging, setLogHandler, setLogLevel, setLogHandler as setLogger };
