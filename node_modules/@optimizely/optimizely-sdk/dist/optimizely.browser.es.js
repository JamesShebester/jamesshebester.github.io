import { v4 } from 'uuid';
import { validate as validate$6 } from 'json-schema';
    ...
    BrowserRequestHandler.prototype.makeRequest = function (requestUrl, headers, method, data) {
        ...
        var responsePromise = new Promise(function (resolve, reject) {
            ...
            request.ontimeout = function () {
                _this.logger.log(LogLevel.WARNING, 'Request timed out');
            };
            request.send(data);
        });
        return {
    ...
    BrowserRequestHandler.prototype.parseHeadersFromXhr = function (request) {
        ...
        headerLines.forEach(function (headerLine) {
            try {
                ...
                _this.logger.log(LogLevel.WARNING, "Unable to parse & skipped header item '".concat(headerLine, "'"));
            }
        });
        return headers;
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        shouldRetry = false;
                        if (events.length === 0) {
                            this.logger.log(LogLevel.ERROR, "".concat(EVENT_SENDING_FAILURE_MESSAGE, " (no events)"));
                    ...
                    case 3:
                        ...
                        this.logger.log(LogLevel.ERROR, "".concat(EVENT_SENDING_FAILURE_MESSAGE, " (").concat(message, ")"));
                        shouldRetry = true;
                        return [3 /*break*/, 4];
                    case 4:
                        if (statusCode >= 400) {
                            this.logger.log(LogLevel.ERROR, "".concat(EVENT_SENDING_FAILURE_MESSAGE, " (").concat(statusCode, ")"));
                        }
                        if (statusCode >= 500) {
                            shouldRetry = true;
                        }
...
var BrowserOdpEventApiManager = /** @class */ (function (_super) {
    ...
    BrowserOdpEventApiManager.prototype.shouldSendEvents = function (events) {
        ...
        this.getLogger().log(LogLevel.ERROR, "".concat(EVENT_SENDING_FAILURE_MESSAGE$1, " (browser only supports batch size 1)"));
        return false;
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        resetCache = options.includes(OptimizelySegmentOption.RESET_CACHE);
                        if (resetCache) {
                            this.reset();
                        }
 ...
 */
function validate$1(jsonObject, validationSchema, shouldThrowOnError) {
    ...
    var result = validate$6(jsonObject, validationSchema);
    if (result.valid) {
        return true;
    }
...
var OdpSegmentApiManager = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        if (!apiKey || !apiHost) {
                            this.logger.log(LogLevel.ERROR, "".concat(AUDIENCE_FETCH_FAILURE_MESSAGE, " (Parameters apiKey or apiHost invalid)"));
                            return [2 /*return*/, null];
                        }
                    ...
                    case 1:
                        ...
                        if (!segmentsResponse) {
                            this.logger.log(LogLevel.ERROR, "".concat(AUDIENCE_FETCH_FAILURE_MESSAGE, " (network error)"));
                            return [2 /*return*/, null];
                        }
                        parsedSegments = this.parseSegmentsResponseJson(segmentsResponse);
                        if (!parsedSegments) {
                            this.logger.log(LogLevel.ERROR, "".concat(AUDIENCE_FETCH_FAILURE_MESSAGE, " (decode error)"));
                            return [2 /*return*/, null];
                        }
                        if (((_a = parsedSegments.errors) === null || _a === void 0 ? void 0 : _a.length) > 0) {
                            ...
                            if (code == 'INVALID_IDENTIFIER_EXCEPTION') {
                                this.logger.log(LogLevel.ERROR, "".concat(AUDIENCE_FETCH_FAILURE_MESSAGE, " (invalid identifier)"));
                            }
                            else {
                                this.logger.log(LogLevel.ERROR, "".concat(AUDIENCE_FETCH_FAILURE_MESSAGE, " (").concat(classification, ")"));
                            }
                            return [2 /*return*/, null];
                        }
    ...
    OdpSegmentApiManager.prototype.parseSegmentsResponseJson = function (jsonResponse) {
        ...
        if (validate$1(jsonObject, OdpResponseSchema, false)) {
            return jsonObject;
        }
        return EMPTY_JSON_RESPONSE;
    };
...
var index_browser = __assign(__assign({}, commonExports), { logging: loggerPlugin, errorHandler: defaultErrorHandler, eventDispatcher: defaultEventDispatcher, sendBeaconEventDispatcher: eventDispatcher, enums: enums, setLogger: setLogHandler$1, setLogLevel: setLogLevel$1, createInstance: createInstance, __internalResetRetryState: __internalResetRetryState, OptimizelyDecideOption: OptimizelyDecideOption, getUserAgentParser: getUserAgentParser });

export default index_browser;
export { LOG_LEVEL, LogLevel, OptimizelyDecideOption, OptimizelySegmentOption, __internalResetRetryState, createInstance, createLogger, enums, defaultErrorHandler as errorHandler, defaultEventDispatcher as eventDispatcher, getLogger, getUserAgentParser, loggerPlugin as logging, eventDispatcher as sendBeaconEventDispatcher, setLogHandler, setLogLevel$1 as setLogLevel, setLogHandler$1 as setLogger };
